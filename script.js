...
function renderProducts(){
    ...
    products.forEach((product) => {
        ...
        listItem.innerHTML = `<p>${product.name}</p> <p>${product.price}</p>
            <div class="button"><span onclick="decrementQuantity(${product.id})" class="decrement"> - </span><span>${product.quantity}</span><span onclick="incrementQuantity(${product.id})" class="decrement"> + </span></div>`;
